...
import { createSaleOrder, updateOrderStatut, deleteSaleOrder, fetchOrders, regenerateOrderPdf, type SaleOrderRow, type PaymentRow, skipSaleReturnWindow, updateSaleReturnFields } from '@/app/atelier/(portal)/sales/actions'
...
function OrderDetailPanel({ order, oeuvres, cM, setInspectedOrder, onClose, onUpdated }: {
  ...
  useEffect(() => {
    async function load() {
      const { fetchPayments } = await import('@/app/atelier/(portal)/sales/actions')
  ...
  async function handleAddPayment(e: React.FormEvent) {
    ...
    setAdding(true)
    const { addPayment } = await import('@/app/atelier/(portal)/sales/actions')
...
function PaymentProgress({ order }: { order: SaleOrderRow }) {
  ...
  useEffect(() => {
    import('@/app/atelier/(portal)/sales/actions').then(({ fetchPayments }) => {
