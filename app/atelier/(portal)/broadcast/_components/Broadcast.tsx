...
} from '@/app/atelier/(portal)/broadcast/actions'
...
function QueueView({
  ...
  rows: import('@/app/atelier/(portal)/broadcast/actions').BroadcastQueueRow[]
...
function PostedView({
  ...
  rows: import('@/app/atelier/(portal)/broadcast/actions').BroadcastPostedRow[]
  t: ReturnType<typeof useI18n>['t']
}) {
  if (rows.length === 0) {
...
function ActivityView({
  ...
  rows: import('@/app/atelier/(portal)/broadcast/actions').BroadcastEventRow[]
  vipOnly: boolean
