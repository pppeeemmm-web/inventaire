    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .p-navlinks { display: flex; gap: 32px; }
      ...
      <nav className="p-nav">
        ...
        <div className="p-navlinks">
          ...
          <Link href="/enquiry"  className="p-navlink">Enquiry</Link>
        </div>
      </nav>
      ...
      <div className="p-body">
        ...
        <section className="p-section">
          <div className="p-section-label">Approche</div>
        ...
        <section className="p-section">
          <div className="p-section-label">Thèmes centraux</div>
          <div className="p-themes">
            {themes.map((t, i) => (
              <div key={i} className="p-theme">{t}</div>
            ))}
          </div>
        </section>

        <section className="p-section">
          <div className="p-section-label">Médiums &amp; matériaux</div>
          <div className="p-text">
            <p>
