...
import type { PortfolioConfig, CollectionItem, WorksMode, ThemeWork } from '@/lib/portfolio-config-types'
import { isHttpsHeroUrl } from '@/lib/portfolio-config-types'
...
export function SiteEditorPanel({
  ...
  return (
    <>
      {/* Pre-existing hardcoded copy — will be i18n'd in the builder phase */}
