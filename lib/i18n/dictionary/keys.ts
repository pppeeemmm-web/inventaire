...
export type DictKey =
  ...
  | 'work_delete_no_rows' | 'work_delete_partial'
  ...
  | 'pending_changes_count' | 'pending_kind_create' | 'pending_kind_image_add' | 'pending_approve' | 'pending_reject'
  ...
  | 'portfolio_save_etag_conflict' | 'portfolio_save_etag_conflict_confirm' | 'portfolio_save_etag_reloaded'
  | 'portfolio_storage_stale_banner' | 'portfolio_storage_stale_reload'
  ...
  | 'contacts_quick_title' | 'contacts_quick_inst' | 'contacts_quick_first' | 'contacts_quick_last' | 'contacts_quick_email' | 'contacts_quick_private' | 'contacts_quick_save' | 'contacts_quick_full' | 'contacts_quick_saving' | 'contacts_quick_live_text'
  ...
  | 'contacts_merge_title' | 'contacts_merge_body' | 'contacts_merge_submit' | 'contacts_merge_success' | 'contacts_merge_refresh_failed'
  ...
  | 'const_strokeWidthTitle' | 'const_drawColorTitle' | 'const_drawLayerClearAllConfirm' | 'const_drawLayerClearAllTitle'
  ...
  | 'hub_field_session' | 'hub_field_session_sub' | 'hub_field_session_sub_admin'
  | 'hub_field_session_title_team'
  ...
  | 'session_new_title' | 'session_new_intro' | 'session_new_intro_admin' | 'session_new_back_atelier' | 'session_new_creating' | 'session_new_sign_in'
  | 'session_work_mode_existing' | 'session_work_mode_new' | 'session_oeuvre_id_label' | 'session_oeuvre_id_label_admin' | 'session_oeuvre_id_placeholder'
  ...
  | 'share_triage_new_work' | 'share_triage_new_work_sub' | 'share_triage_split_all' | 'share_triage_split_one'
  | 'share_triage_recent_works' | 'share_triage_pending_images' | 'share_triage_lightroom_hint'
  | 'share_triage_return_session' | 'share_triage_return_session_hint' | 'share_triage_attach_session'
  | 'share_triage_session_attached'
  | 'wf_share_pending_heading' | 'wf_images_lightroom_hint'
  | 'hub_field_lightroom' | 'hub_field_lightroom_sub'
  | 'hub_lightroom_modal_title' | 'hub_lightroom_modal_body' | 'hub_lightroom_modal_got_it' | 'hub_lightroom_open_app'
  | 'lightroom_try_open_app' | 'lightroom_open_failed_hint' | 'lightroom_app_store' | 'lightroom_steps_hide'
  ...
  | 'capture_card_title' | 'capture_card_intro' | 'capture_card_placeholder' | 'capture_card_live_text_focus'
