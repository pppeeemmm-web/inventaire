...
- **Release evidence:** before completion wording, run or derive the fields from `pwsh scripts/release-truth.ps1`: branch, HEAD SHA, origin/main SHA, HEAD==origin/main, working tree, checks, and deploy SHA when claiming online/deployed.
