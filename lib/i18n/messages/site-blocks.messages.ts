...
export const siteBlocksMessages = defineMessages({
  ...
  // Page-tabbed composition editor
  site_composition_title: { fr: 'Composition', en: 'Composition' },
  site_composition_help: {
    fr: 'Blocs de contenu par page. Ajouter, réordonner, masquer.',
    en: 'Content blocks per page. Add, reorder, hide.',
  },
  site_page_landing: { fr: 'Accueil', en: 'Landing' },
  site_page_works: { fr: 'Œuvres', en: 'Works' },
  site_page_about: { fr: 'À propos', en: 'About' },
  site_block_add: { fr: '+ Ajouter un bloc', en: '+ Add a block' },
  site_block_no_descriptor: {
    fr: 'Géré ailleurs',
    en: 'Managed elsewhere',
  },
  site_block_empty_page: {
    fr: 'Aucun bloc sur cette page.',
    en: 'No blocks on this page.',
  },
  site_block_kind_text: { fr: 'Texte', en: 'Text' },
  site_block_kind_biographie: { fr: 'Biographie', en: 'Biography' },
  site_block_kind_approach: { fr: 'Approche', en: 'Approach' },
  site_block_kind_themes: { fr: 'Thèmes', en: 'Themes' },
  site_block_kind_materials: { fr: 'Matériaux', en: 'Materials' },
  site_block_layout_full: { fr: 'Pleine largeur', en: 'Full width' },
  site_block_layout_half: { fr: 'Demie', en: 'Half' },
  site_block_layout_third: { fr: 'Tiers', en: 'Third' },
  site_block_action_remove: { fr: 'Supprimer', en: 'Remove' },
  site_block_action_move_up: { fr: 'Monter', en: 'Move up' },
