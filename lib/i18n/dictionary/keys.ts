...
export type DictKey =
  ...
  | 'overview' | 'inventory' | 'ov_works_loaded_hint' | 'inv_refinement_gate' | 'atelier_oeuvres_load_more' | 'atelier_oeuvres_load_more_short' | 'atelier_oeuvres_subset_chip' | 'atelier_oeuvres_subset_banner' | 'atelier_header_works_badge_title' | 'ov_loaded_subset_caption' | 'prod_tab_loaded_subset_note' | 'prod_tab_pivot_footnote_loaded_subset' | 'inv_loaded_batch_suffix' | 'constellation' | 'production'
  ...
  | 'pub_works_carousel_prev' | 'pub_works_carousel_next' | 'pub_works_zoom_hint' | 'pub_works_zoom_exit' | 'pub_works_zoom_close_aria' | 'pub_works_nav_hint'
  | 'loadingAtelier' | 'catalogue_loading'
  ...
  | 'bc_count_candidates' | 'bc_team_only' | 'bc_platform_filter' | 'bc_search_placeholder' | 'bc_refresh'
  | 'bc_candidates_title' | 'bc_candidates_empty' | 'bc_queue_now' | 'bc_detail_title' | 'bc_detail_empty'
  | 'bc_close' | 'bc_open_work' | 'bc_external_url' | 'bc_confirm_post' | 'bc_save_post'
  | 'bc_note_title' | 'bc_priority_normal' | 'bc_priority_vip' | 'bc_note_placeholder' | 'bc_add_note'
  | 'bc_action_ok'
  ...
  | 'pending_sessions_title' | 'pending_sessions_intro' | 'pending_sessions_loading' | 'pending_sessions_empty'
  | 'pending_sessions_shots' | 'pending_sessions_apply_confirm'
  | 'session_photos_staged_hint' | 'session_submit_sent_audit' | 'session_apply_photos_hint'
  ...
  | 'pipeline_cal_range_week' | 'pipeline_cal_range_month' | 'pipeline_cal_range_quarter' | 'pipeline_cal_range_semester' | 'pipeline_cal_range_year'
  | 'pipeline_cal_range_week_short' | 'pipeline_cal_range_month_short' | 'pipeline_cal_range_quarter_short' | 'pipeline_cal_range_semester_short' | 'pipeline_cal_range_year_short'
  | 'pipeline_cal_range_group_aria' | 'pipeline_cal_prev' | 'pipeline_cal_next' | 'pipeline_cal_today'
  | 'pipeline_cal_week_col_aria' | 'pipeline_cal_week_short' | 'pipeline_cal_more_fmt'
  | 'pipeline_cal_quarter_title_fmt' | 'pipeline_cal_semester_h1' | 'pipeline_cal_semester_h2'
  | 'pipeline_cal_pick_day' | 'pipeline_cal_no_events_day' | 'pipeline_cal_dismiss_reminder'
  ...
  | 'vault_no_documents' | 'vault_no_results' | 'vault_name' | 'vault_type_size'
  | 'vault_folder' | 'vault_preview_unavailable' | 'vault_preview_loading'
  | 'vault_type' | 'vault_work' | 'vault_size' | 'vault_open_new_tab'
  | 'vault_view' | 'vault_download'
  | 'vault_kind_coa' | 'vault_kind_contrat' | 'vault_kind_facture' | 'vault_kind_pret'
  | 'vault_kind_police' | 'vault_kind_brouillon' | 'vault_kind_ecriture'
  | 'vault_kind_bible' | 'vault_kind_autre'
  ...
  | 'analytics_delta_previous_period' | 'analytics_delta_no_baseline' | 'analytics_views_per_net_visitor'
  | 'analytics_returning_visitors' | 'analytics_returning_visitors_hint' | 'analytics_one_page_visitors' | 'analytics_one_page_visitors_hint'
  | 'analytics_browsing_depth' | 'analytics_depth_1' | 'analytics_depth_2_3' | 'analytics_depth_4_7' | 'analytics_depth_8_plus'
  | 'analytics_landing_pages' | 'analytics_source_quality' | 'analytics_source_quality_hint' | 'analytics_source_quality_row_fmt'
  ...
  | 'pub_aria_switch_language' | 'pub_aria_go_home' | 'pub_logo_text'
  ...
  | 'report_presets_heading' | 'report_active_preset'
  | 'report_preset_custom_title' | 'report_preset_custom_desc'
  | 'report_preset_valuation_title' | 'report_preset_valuation_desc'
  | 'report_preset_missing_title' | 'report_preset_missing_desc'
  | 'report_preset_location_title' | 'report_preset_location_desc'
  | 'report_preset_exhibition_title' | 'report_preset_exhibition_desc'
  | 'report_preset_sales_title' | 'report_preset_sales_desc'
  ...
  | 'cmd_palette_action_new_work' | 'cmd_palette_action_new_session' | 'cmd_palette_action_capture' | 'cmd_palette_action_new_issue'
  | 'cmd_palette_action_new_document' | 'cmd_palette_action_triage' | 'cmd_palette_action_scan'
  | 'cmd_palette_action_export_xlsx' | 'cmd_palette_action_regen_bible'
  ...
  | 'voice_dictate_unsupported' | 'voice_dictate_insecure' | 'voice_dictate_unavailable' | 'voice_mic_error'
  | 'voice_save' | 'voice_saving'
  ...
  | 'session_work_mode_existing' | 'session_work_mode_new' | 'session_oeuvre_id_label' | 'session_oeuvre_id_placeholder'
  ...
  | 'capture_card_title' | 'capture_card_intro' | 'capture_card_placeholder'
  | 'capture_card_add_photo' | 'capture_card_analyze' | 'capture_card_preview_heading'
  | 'capture_card_create' | 'capture_card_ok' | 'capture_card_err_empty' | 'capture_card_ocr_failed'
  | 'capture_card_refine_llm' | 'capture_card_vision_note' | 'capture_card_err_no_identity'
